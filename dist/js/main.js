(function(appl) {
    ...
    function getVideos(el) {
        el.addEventListener("click", function() {
            ...
            iframe.setAttribute("src", "http://www.youtube.com/embed/" + this.id + "?autoplay=1&autohide=1&border=0&wmode=opaque&enablejsapi=1");
        ...
        if (name.val() === "") {
            ...
            $.ajax({
                ...
                success: function(data) {
                    alertify.success("Спасибо за ваш запрос. Я скоро вам позвоню или напишу.");
                }
            });
            $("#modal1").closeModal();
            e.preventDefault();
